...
function pointmath.AngleFromOrigin(point, up, origin)
    origin = origin or Vector3.__new(0,0,0)
    local v2 = point - origin
    return math.atan2(v2.Z,v2.X) - math.atan2(up.Z, up.X)

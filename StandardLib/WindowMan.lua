...
local function add_label(label, value, type, options)
    options = options or nil
    if not type == "dropdown" and not type == 7 then
        options = nil
    end
    if type == "label" or type == 0 then
    elseif type == "Button" or type == 1 then
    elseif type == "label" or type == 2 then
    elseif type == "label" or type == 3 then
    elseif type == "label" or type == 4 then
    elseif type == "label" or type == 5 then
    elseif type == "label" or type == 6 then
    elseif type == "dropdown" or type == 7 then
        
    end
end
local function destroy_label(i)
end
local function edit_label(label, value, i, options)
    options = options or nil
    if not type == "dropdown" and not type == 7 then
        options = nil
    end

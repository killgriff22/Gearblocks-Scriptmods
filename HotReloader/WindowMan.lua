local WindowMan = {}
local function CreateWindow(l,w,x,y,closefunc)
    local localwindow
    x = x or 80
    y = y or 20
    localwindow = Windows.CreateWindow()
    localwindow.SetAlignment(align_RightEdge,y,l)
    localwindow.SetAlignment(align_TopEdge,x,w)
...
local function CreateLabelledToggle(x,y,w,h,txt,localwindow,default)
...
local function CreateInputField(x,y,w,h,txt,localwindow,default)
